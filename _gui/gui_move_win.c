...
#define TOOLBAR_HEIGHT  0        // pas de fen阾re Toolbar
...
{
	ONGLET_TFTP_SERVER,   "Tftp 服务器" ,  TFTPD32_TFTP_SERVER,	   SERVICE_STOPPED,
	ONGLET_TFTP_CLIENT,   "Tftp 客户端",   TFTPD32_TFTP_CLIENT,    SERVICE_STOPPED,
	ONGLET_DHCP_SERVER,   "DHCP 服务器",   TFTPD32_DHCP_SERVER,    SERVICE_STOPPED,
	ONGLET_SYSLOG_SERVER, "Syslog 服务器", TFTPD32_SYSLOG_SERVER,  SERVICE_STOPPED,
	ONGLET_SNTP_SERVER,   "SNTP 服务器",   TFTPD32_SNTP_SERVER,    SERVICE_STOPPED,
	ONGLET_DNS_SERVER,    "DNS 服务器",    TFTPD32_DNS_SERVER,     SERVICE_STOPPED,
	ONGLET_EVENTS_VIEWER, "日志 查看",    TFTPD32_NONE,           SERVICE_STOPPED,
};  // tTabCtrlData
